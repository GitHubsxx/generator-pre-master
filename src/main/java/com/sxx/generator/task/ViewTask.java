...
public class ViewTask extends BaseTask {
     ...
     * 1.单表生成  2.多表时生成子表实体
     */
    public ViewTask(String className, List<ColumnInfo> infos) {
     ...
     * 一对多关系生成主表实体
     */
    public ViewTask(String className, String parentClassName, String foreignKey, List<ColumnInfo> tableInfos) {
     ...
     * 多对多关系生成主表实体
     */
    public ViewTask(String className, String parentClassName, String foreignKey, String parentForeignKey, List<ColumnInfo> tableInfos) {
    ...
    public void run() throws IOException, TemplateException {
        ...
        entityData.put("baseData", GeneratorUtil.createBaseDataView(entityData));
        ...
        String fileName =  LowerCaseUtils.generateFtlName(className)+"-" + "view.ftl";
        // 生成Entity文件
        FileUtil.generateToJava(FreemarketConfigUtils.TYPE_VIEW, entityData, filePath + fileName);
    }
}
